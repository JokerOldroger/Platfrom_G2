...
from .orchestration.service import check_internal_waits, check_timed_device_steps, start_job
...
def batch_job_check_timeouts(request, job_id):
    ...
    timed_result = check_timed_device_steps(
        job,
        resolve_dispatch_command=_resolve_dispatch_command,
        dispatch_transport_message=_dispatch_transport_message,
        can_dispatch_to_device=can_dispatch_to_device,
    ...
    return Response({
        ...
        'completed_timed_steps': timed_result.completed_steps,
        'timed_dispatched_messages': CommandOutboxSerializer(timed_result.dispatched_messages, many=True).data,
        'timed_failed_steps': timed_result.failed_steps,
